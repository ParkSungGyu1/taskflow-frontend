    ...
    <Container maxWidth="xl" sx={{ pb: 6, px: { xs: 2, sm: 3, md: 4 } }}>
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', width: { xs: '100%', sm: 'auto' } }}>
          ...
          <MuiTooltip title="대시보드 옵션">
            <IconButton onClick={handleMenuOpen} sx={{ p: 1.5 }}>
              <MoreIcon />
            </IconButton>
          </MuiTooltip>
          <Menu
          ...
          >
            <MenuItem onClick={handleMenuClose}>기간 변경</MenuItem>
            <MenuItem onClick={handleMenuClose}>데이터 새로고침</MenuItem>
            <MenuItem onClick={handleMenuClose}>대시보드 설정</MenuItem>
          </Menu>
        </Box>
      </Box>
